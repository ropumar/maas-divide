...
class Operation(Node):
    ...
    def addWhereOpen(self, child):
        ...
        if self.right is None:
            ...
            if isinstance(self.left, Operation) and isinstance(
    ...
    def toInfixNotation(self):
        ...
        if self.arity == 1:
            ...
            if (
                isinstance(self.left, Operation)
                and self.weight > self.left.weight
            ):
                string = "(" + lstring + ")"
            else:
                string = lstring
            ...
            string = ""
            if (
                ifInstance(self.left, Operation)
                and self.weight > self.left.weight
            ):
                string += "(" + lstring + ")"
            else:
            ...
            string += " " + self.symbol + " "
            if (
                isinstance(self.right, Operation)
                and self.weight > self.right.weight
            ):
                string += "(" + rstring + ")"
            else:
                string += rstring
